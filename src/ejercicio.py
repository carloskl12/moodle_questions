...
class Ejercicio (object):
  ...
  '''
  def __init__(self, enunciado,preguntas, grupo,tipo=-1):
    self.grupo=grupo
    self.tipo=tipo
  ...
  def Respuesta(self,enunciado, respuestas):
    '''
  ...
  def __call__(self,o=6, total=-1):
    ...
    if self.tipo==0:
      ...
      for i in range(np):
        ...
        s+=self.Respuesta(enunciado, respuestas)+'\n'
